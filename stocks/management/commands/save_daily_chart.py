...
from stocks.models import Info, DailyChart
                ...
                if current_batch:
                    ...
                    if old_dates:
                        ...
                        if oldest_date < cutoff_date:
                            self.stdout.write(f'2년 이전 데이터 도달 ({oldest_date}) - 중단')
                            break
    ...
    def save_to_db(self, stock_code, data_list):
        ...
        for item in data_list:
            try:
                ...
                daily_chart, created = DailyChart.objects.update_or_create(
                    stock=stock,
                    date=date,
                    defaults={
