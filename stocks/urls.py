...
urlpatterns = [
    ...
    path('api/stock/<str:code>/quarter-analysis/', views.quarter_analysis_save, name='quarter_analysis_save'),
    path('api/stock/<str:code>/quarter-analysis/data/', views.quarter_analysis_data, name='quarter_analysis_data'),
